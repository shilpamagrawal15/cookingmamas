...
var levels = 
	{
		1: 
			{
				objective: "Your client, Richard Richards, is hosting a dinner party for his neighborhood book club. He wants enough" + "<b>" + " entrees for 25 guests" + "</b>" + " (you can make more than 25 and still be correct) and enough " + "<b>" + "dessert for 40" + "</b>" + " guests. Keep in mind that if you make cake for dessert, you have to make entire cakes. Serve up amazing food for Richard Richards, please Chef Klopfer with delectable recipes, and you'll be well on your way!",
		...
		2: 
			{
				objective: "Your client, Maria Marks, is throwing a graduation party for her daughter, Melissa Marks. She wants enough " + "<b>" + "entrees for 20 " + "</b>" + " guests and enough " + "<b>" + "dessert for 20" + "</b>" + " guests. Keep in mind that your pantry has changed, and that if you make cake for dessert, you have to make entire cakes. Chef Klopfer still demands delectable dishes!",
				recipes: ["Peanut Butter Cookies", "Lemon Pound Cake", "Sauteed Asparagus", "Shrimp Linguini"],
				cabinet:
					[
						{type: "peanut_butter", quantity: 5},
